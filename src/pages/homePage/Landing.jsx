...
const Landing = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-400 to-purple-900 cursor-none">
      ...
      >
        <a href="/">
          <img src="/images/png/Union.png" className="h-[50px] cursor-none" alt="" />
        </a>
        <ul>
          <li>
            <a className="font-bold cursor-none" href="/about">
              About Us
            </a>
          </li>
          <li>
            <a className="font-bold cursor-none" href="/services">
              Services
            </a>
          </li>
          <li>
            <a className="font-bold cursor-none" href="/contact">
              Contact
            </a>
          </li>
        </ul>
