  ...
  return (
      <div className="flex flex-col items-start py-40 pl-40 bg-gray-200">
        <span className={` text-[22px] w-2/3`}>
          Partnering with passionate leaders and visionary entrepreneurs, we
          apply creativity, strategy, design and data to re-invent businesses,
          drive growth and orchestrate customer centric transformation.
        </span>
