...
const ProvidedServices = () => {
  ...
  return (
    <div className="w-full flex justify-center bg-pblue">
      <div className="w-full max-w-[1366px] hidden md:flex flex-col">
        <span className="w-full text-center text-[50px] text-white mt-10 py-10 text-inter font-extrabold">
          Services We Provide
        </span>
        <div className="w-full text-right flex items-center">
          <div className="md:w-1/2 flex flex-col items-center provided-services-text justify-center p-10">
          ...
          <div className="md:w-1/2 flex flex-col items-center overflow-hidden">
            <img
              ...
              className="object-cover provided-services-image hidden md:flex"
            />
          </div>
        </div>
        <div className="w-full text-left flex flex-row-reverse items-center">
          <div className="md:w-1/2 flex flex-col provided-services-right-text items-start p-10">
      ...
      <div className="w-full max-w-[1366px] flex md:hidden flex-col">
        <span className="w-full text-center text-[32px] text-white mt-10 text-inter font-extrabold">
          Services We Provide
        </span>
        <div className="w-full text-right flex items-center">
