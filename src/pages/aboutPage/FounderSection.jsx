  ...
  return (
    <div className="w-full flex justify-center bg-oblue">
      <div
        ...
        className="flex justify-start w-full max-w-[1366px] trigger overflow-hidden"
      >
        <div
        ...
        <div
          id="sireesha-right"
          className={`w-1/2 py-16 px-32 flex flex-col overflow-hidden bg-oblue font-jose text-[22px] text-black`}
        >
